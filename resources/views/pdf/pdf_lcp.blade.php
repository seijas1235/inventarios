...
<head>
    ...
    <title>Listado de Cupones PUMA por Día</title>
...
<body><div class="container">
 <div class="row">
    <div class="col-md-12">
        <h1 style="text-align:center;">Listado de Cupones PUMA por Día </h1>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            <tr>
                <td style="font-size:20px;"> Total de Cupones </td>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th width=15%>No Cupon</th>
                    <th width=15%>Cod Cliente</th>
                    <th width=65%>Nombre Cliente</th>
            ...
            <tbody>
                @foreach ($data as $dat)
                <tr>
                    <td style="font-size:13px;">{{ $dat->no_cupon }}</td>
                    <td style="font-size:13px;">{{ $dat->codigo_cliente }}</td>
                    <td style="font-size:13px;">{{ $dat->nombre_cliente }}</td>
