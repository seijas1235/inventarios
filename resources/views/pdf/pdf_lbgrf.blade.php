...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
    ...
    <title>Listado de Repuestos para BG</title>
...
<body><div class="container">
 <div class="row">
    <div class="col-md-12">
        <h1 style="text-align:center;">Listado de Repuestos para BG </h1>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            <tr>
                <td style="font-size:20px;"> Total de Gastos de Repuestos </td>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:13px;">{{ $dat->documento }}</td>
                    <td style="font-size:13px;">{{ $dat->no_documento }}</td>
                    <td style="font-size:13px;">Q. {{{number_format((float) $dat->monto, 2) }}}</td>
                    <td style="font-size:13px;">{{ $dat->descripcion }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
