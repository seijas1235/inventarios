...
<head>
    ...
    <title>Listado de Vouchers por Día</title>
...
<body><div class="container">
 <div class="row">
    <div class="col-md-12">
        <h1 style="text-align:center;">Listado de Vouchers por Día </h1>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            <tr>
                <td style="font-size:20px;"> Total en Vouchers de Tarjeta </td>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            ...
            <tbody>
                @foreach ($data as $dat)
                <tr>
                    <td style="text-align:center;">{{ $dat->no_lote }}</td>
