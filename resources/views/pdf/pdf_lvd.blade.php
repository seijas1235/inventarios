...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
    ...
    <title>Listado de Vales por Fecha</title>
...
<body><div class="container">
 <div class="row">
    <div class="col-md-12">
        <h1 style="text-align:center;">Listado de Vales por Fecha </h1>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            ...
            <tr>
                <td style="font-size:15px;"> Fecha de impresión: {{ Carbon\Carbon::parse($today)->format('d-m-Y H:i:s') }} </td>
            </tr>
            <tr>
                <td style="font-size:15px;"> Fecha: {{ Carbon\Carbon::parse($fecha)->format('d-m-Y') }}  </td>
            </tr>
        </table>
        <br>
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $dat->Cliente }}</td>
                    <td>{{ $dat->piloto }}</td>
                    <td>{{ $dat->Tipo_Combustible }}</td>
                    <td>Q. {{{number_format((float) $dat->Cargo, 2) }}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
