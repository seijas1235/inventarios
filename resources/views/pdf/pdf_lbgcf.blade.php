...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
    ...
    <title>Listado de Combustibles para BG</title>
...
<body><div class="container">
 <div class="row">
    <div class="col-md-12">
        <h1 style="text-align:center;">Listado de Combustibles para BG </h1>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            <tr>
                <td style="font-size:20px;"> Total de Gastos de Combustibles </td>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:13px;">{{{number_format((float) $dat->galones, 2) }}}</td>
