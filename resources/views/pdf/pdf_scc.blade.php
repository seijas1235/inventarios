...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
    ...
    <title>Listado de Saldos de Clientes</title>
...
<body><div class="container">
 <div class="row">
    <div class="col-md-12">
        <h1 style="text-align:center;">Listado de Saldos de Clientes </h1>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            <tr>
                <td style="font-size:20px;"> Total de Cuentas por Cobrar </td>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            <thead>
                <tr>
                    ...
                    <th width=15%>Fecha Ultimo Registro</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($data as $dat)
                <tr>
                    ...
                    <td style="font-size:13px; text-align:right;">Q.{{{number_format((float) $dat->cl_saldo, 2) }}}</td>
                    <td style="font-size:13px; text-align:right;">{{ Carbon\Carbon::parse($dat->fecha_saldo)->format('d-m-Y') }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
