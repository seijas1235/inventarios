...
<head>
    ...
    <title>Listado de Anticipos a Empleados por Día</title>
...
<body><div class="container">
 <div class="row">
    <div class="col-md-12">
        <h1 style="text-align:center;">Listado de Anticipos a Empleados por Día </h1>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            <tr>
                <td style="font-size:20px;"> Total de Anticipos del día </td>
        ...
        <table border="1" cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
            ...
            <tbody>
                @foreach ($data as $dat)
                <tr>
                    <td style="text-align:center;">{{ $dat->empleado }}</td>
                    <td style="text-align:center;">{{ $dat->documento }}</td>
                    <td style="text-align:center;">{{ $dat->no_documento }}</td>
                    <td style="text-align:right;">Q. {{{number_format((float) $dat->total, 2) }}}</td>
                    <td style="text-align:left;">{{ $dat->observaciones }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
