...
<div id="content">
	<div class="container-custom">
		...
		{!! Form::open( array( 'id' => 'MedidasForm') ) !!}
		<div class="row">
			<div class="col-sm-12">
				<h3 class="tittle-custom"> Registro de Medidas de Tanques </h3>
				<line>
				</div>
			</div>
			<br>
			...
			<div class="text-right m-t-15">
				...
				{!! Form::input('submit', 'submit', 'Guardar', ['class' => 'btn btn-primary form-gradient-color form-button', 'id'=>'ButtonMedidas']) !!}
			</div>
			<br>
...
@endsection
@section('scripts')
{!! HTML::script('/../../sfi_tecu/sfi/js/medidas/create.js') !!}
@endsection