...
<div id="content">
	<div class="container-custom">
		...
		{!! Form::open( array( 'id' => 'CuponesForm') ) !!}
		<div class="row">
			<div class="col-sm-12">
				<h3 class="tittle-custom"> Registro de Cupones de Combustible PUMA </h3>
				<line>
				</div>
			</div>
			<br>
			...
			<div class="text-right m-t-15">
				...
				{!! Form::input('submit', 'submit', 'Guardar', ['class' => 'btn btn-primary form-gradient-color form-button', 'id'=>'ButtonCupones']) !!}
			</div>
			<br>
...
@endsection
@section('scripts')
{!! HTML::script('/../../sfi_tecu/sfi/js/cupones/create.js') !!}
@endsection