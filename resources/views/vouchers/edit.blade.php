...
<div id="content">
    <div class="container-custom">
        ...
        {!! Form::model($voucher, ['method' => 'PATCH', 'action' => ['VoucherTarjetaController@update', $voucher->id], 'id' => 'VouchersUpdateForm']) !!}

        <div class="row">
            <div class="col-sm-12">
                <h3 class="tittle-custom"> Edici¨®n de Voucher de Tarjetas  </h3>
            </div>
        </div>
        <br>
        <div class="row">
        ...
        <div class="text-right m-t-15">
            ...
            {!! Form::input('submit', 'submit', 'Editar', ['class' => 'btn btn-primary form-gradient-color form-button', 'id'=>'ButtonUpdateVouchers']) !!}
        </div>
...
@endsection
@section('scripts')
{!! HTML::script('/../../sfi/sfi/js/vouchers/edit.js') !!}
@endsection