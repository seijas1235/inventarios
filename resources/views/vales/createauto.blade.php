...
<div id="content">
	<div class="container-custom">
		...
		<div class="row">
			...
			<div class="row">
				<div class="col-sm-3">
					...
					{!! Form::number( "no_vale" , $vale->indice + 1 , ['class' => 'form-control' , 'id' => 'no_vale', 'disabled' => true]) !!}
				</div>
				<div class="col-sm-3">
		...
		<div class="col-sm-2">
			{!! Form::label("total_vale","Cantidad en Q.:") !!}
...
@endsection
@section('scripts')
{!! HTML::script('/../../sfi/sfi/js/vales/createauto.js') !!}
@endsection