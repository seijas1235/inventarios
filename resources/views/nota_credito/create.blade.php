...
<div id="content">
	<div class="container-custom">
		{!! Form::open( array( 'id' => 'NotasCreditosForm') ) !!}
		<div class="row">
			<div class="col-sm-12">
				<h3 class="tittle-custom"> Registro de Notas de Créditos </h3>
				<line>
				</div>
			</div>
			<br>
			...
			<div class="text-right m-t-15">
				...
				{!! Form::input('submit', 'submit', 'Guardar', ['class' => 'btn btn-primary form-gradient-color form-button', 'id'=>'ButtonNotasCreditos']) !!}
			</div>
			<br>
...
@endsection
@section('scripts')
{!! HTML::script('/../../sfi_tecu/sfi/js/nota_credito/create.js') !!}
@endsection