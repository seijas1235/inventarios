...
<div id="content">
	<div class="container-custom">
		{!! Form::open( array('class'=> 'form', 'id' => 'IngresoForm') ) !!}
		<div class="row">
			<div class="col-sm-12">
				<h3 class="tittle-custom"> Ingreso Caja Chica </h3>
				<line>
			</div>
		</div>
			<br>
			...
			<div class="text-right m-t-15">
				...
				{!! Form::input('submit', 'submit', 'Guardar', ['class' => 'btn btn-primary form-gradient-color form-button', 'id'=>'ButtonIngreso']) !!}
			</div>
