var cupones_table = $('#cupones-table').DataTable({
    "ajax": "/sfi_tecu/cupones/getJson",
    "responsive": true,
    "processing": true,
    "serverSide": true,
    "info": true,
    ...
    "columns": [ {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/sfi_tecu/cupones/edit/"+ full.id +"' class='edit-cupon'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar Medida'></i>" + 
            "</div>" + "<div class='float-right col-lg-6'>" + 
            "<a href='#' class='remove-cupon'>" + 
            "<i class='fa fa-btn fa-trash' title='Eliminar Cupon'></i>" + 
            "</a>" + "</div>";;
        },
        "responsivePriority": 2
    }],
...
$('body').on('click', 'a.remove-cupon', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    var url = "/sfi_tecu/cupones/remove/"+id;
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Cupon eliminado exitosamente!");
        cupones_table.ajax.reload();
