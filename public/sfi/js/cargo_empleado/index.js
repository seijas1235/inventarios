var cargo_empleado_table = $('#cargo_empleado-table').DataTable({
    "ajax": "/sfi/cargos/getJson",
    "responsive": true,
    "processing": true,
    "serverSide": true,
    "info": true,
    ...
    "columns": [ {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/sfi/cargos/edit/"+ full.id +"' class='edit-cargo_empleado'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar'></i>" + 
            "</div>" + "<div class='float-left col-lg-6'>" + 
            "<a href='#' class='remove-cargo_empleado'>" + 
...
$('body').on('click', 'a.remove-cargo_empleado', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Cargo Empleado borrado exitosamente!");
        cargo_empleado_table.ajax.reload();
