var saldos_clientes_table = $('#saldos_clientes-table').DataTable({
    "ajax": "/sfi/saldos_clientes/getJson",
    "responsive": true,
    "processing": true,
    "serverSide": true,
    "info": true,
    ...
    "columns": [ {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/sfi/saldos_clientes/edit/"+ full.id +"' class='edit-saldo_cliente'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar Reg'></i>" + 
            "</div>" + "<div class='float-right col-lg-6'>" + 
            "<a href='#' class='remove-saldo_cliente'>" + 
            "<i class='fa fa-btn fa-trash' title='Eliminar Reg'></i>" + 
            "</a>" + "</div>";;
        },
        "responsivePriority": 2
    }],
...
$('body').on('click', 'a.remove-saldo_cliente', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    var url = "/sfi/saldos_clientes/remove/"+id;
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Registro eliminado exitosamente!");
        saldos_clientes_table.ajax.reload();
