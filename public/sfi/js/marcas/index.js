var marca_table = $('#marca-table').DataTable({
    "ajax": "/sfi/marca/getJson",
    "responsive": true,
    "processing": true,
    "serverSide": true,
    "info": true,
    ...
    "columns": [ {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/sfi/marcas/edit/"+ full.id +"' class='edit-marca'>" + 
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Marca borrada exitosamente!");
        marca_table.ajax.reload();
