var bomba_table = $('#bomba-table').DataTable({
    "ajax": "/sfi/bombas/getJson",
    "responsive": true,
    "processing": true,
    "serverSide": true,
    "info": true,
    ...
    "columns": [  {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/sfi/bombas/edit/"+ full.id +"' class='edit-bomba'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar Bomba'></i>" + 
            "</a>" + "</div>" + 
            "<div class='float-right col-lg-3'>" + 
            "<a href='#' class='remove-bomba'>" + 
            "<i class='fa fa-btn fa-trash' title='Eliminar Bomba'></i>" + 
            "</a>" + "</div>";
        },
...
$('body').on('click', 'a.remove-bomba', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Bomba eliminada exitosamente!");
        bomba_table.ajax.reload();
