var producto_table = $('#producto-table').DataTable({
    ...
    "columns": [ {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/sfi/productos/edit/"+ full.id +"' class='edit-producto'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar Producto'></i>" + 
            "</div>"  + "<div class='float-right col-lg-3'>" + 
            "<a href='#' class='remove-producto'>" + 
            "<i class='fa fa-btn fa-trash' title='Desactivar Producto'></i>" + 
            "</a>" + "</div>";
        },
        "responsivePriority": 2
    }],
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    var url = "/sfi/productos/remove/"+id;
