var gastos_table = $('#gastos-table').DataTable({
    ...
    "columns": [ {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/sfi_tecu/gastos/edit/"+ full.id +"' class='edit-gasto'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar'></i>" + 
            "</div>" + "<div class='float-right col-lg-6'>" + 
            "<a href='#' class='remove-gasto'>" + 
...
$('body').on('click', 'a.remove-gasto', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    var url = "/sfi_tecu/gastos/remove/"+id;
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Gasto eliminado exitosamente!");
