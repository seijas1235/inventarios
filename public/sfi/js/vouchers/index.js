var voucher_table = $('#voucher-table').DataTable({
    "ajax": "/sfi/vouchers/getJson",
    "responsive": true,
    "processing": true,
    "serverSide": true,
    "info": true,
    ...
    "columns": [ {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/sfi/vouchers/edit/"+ full.id +"' class='edit-voucher'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar Voucher'></i>" + 
            "</a>" + "</div>" + 
            "<div class='float-right col-lg-3'>" + 
            "<a href='#' class='remove-voucher'>" + 
            "<i class='fa fa-btn fa-trash' title='Eliminar Voucher'></i>" + 
            "</a>" + "</div>";
        },
        "responsivePriority": 2
    }],
...
$('body').on('click', 'a.remove-voucher', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    var url = "/sfi/vouchers/remove/"+id;
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Voucher eliminado exitosamente!");
