var precios_producto_table = $('#precios_producto-table').DataTable({
    ...
    },
    {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/precios_producto/edit/"+ full.id +"' class='edit-precioproducto'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar Precio'></i>" + 
            "</a>" + "</div>" + 
            "<div class='float-right col-lg-6'>" + 
            "<a href='#' class='remove-precioproducto'>" + 
            "<i class='fa fa-btn fa-trash' title='Eliminar Precio'></i>" + 
            "</a>" + "</div>";
...
$('body').on('click', 'a.remove-precioproducto', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    var url = "/precios_producto/remove/"+id;
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Precio eliminado exitosamente!");
        precios_producto_table.ajax.reload();
