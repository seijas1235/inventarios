var tiposvehiculo_table = $('#tiposvehiculo-table').DataTable({
    "ajax": "/tipos_vehiculo/getJson",
    "responsive": true,
    "processing": true,
    "serverSide": true,
    "info": true,
...
$('body').on('click', 'a.remove-tipovehiculo', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    var url = "/tipos_vehiculo/remove/"+id;
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Tipo de vehiculo eliminado exitosamente!");
        tiposvehiculo_table.ajax.reload();
