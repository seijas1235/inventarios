var unidadesdemedida_table = $('#unidadesdemedida-table').DataTable({
       ...
       
    {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/unidades_de_medida/edit/"+ full.id +"' class='edit-unidaddemedida'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar Tipo Cliente'></i>" + 
            "</a>" + "</div>" + 
            "<div class='float-right col-lg-6'>" + 
            "<a href='#' class='remove-unidaddemedida'>" + 
...
$('body').on('click', 'a.remove-unidaddemedida', function(e) {
    ...
    if (user.length = 1) {
        $("#message").text("esta unidad de medida?");
        $(".variable").text("");
        $(".entity").text("");
    } else {
        $("#message").text("esta unidad de medida");
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    var url = "/unidades_de_medida/remove/"+id;
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Unidad de medida eliminada exitosamente!");
        unidadesdemedida_table.ajax.reload();
