var documentos_table = $('#documentos-table').DataTable({
    ...
    },       
    {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/documentos/edit/"+ full.id +"' class='edit-documento'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar Tipo Cliente'></i>" + 
            "</a>" + "</div>" + 
            "<div class='float-right col-lg-6'>" + 
            "<a href='#' class='remove-documento'>" + 
...
$('body').on('click', 'a.remove-documento', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("documento eliminado exitosamente!");
        documentos_table.ajax.reload();
