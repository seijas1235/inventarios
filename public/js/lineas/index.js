var lineas_table = $('#lineas-table').DataTable({
          ...
          
    {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/lineas/edit/"+ full.id +"' class='edit-linea'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar Linea'></i>" + 
            "</a>" + "</div>" + 
            "<div class='float-right col-lg-6'>" + 
            "<a href='#' class='remove-linea'>" + 
            "<i class='fa fa-btn fa-trash' title='Eliminar Linea'></i>" + 
            "</a>" + "</div>";
...
$('body').on('click', 'a.remove-linea', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Linea eliminada exitosamente!");
        lineas_table.ajax.reload();
