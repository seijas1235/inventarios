var maquinariaequipo_table = $('#maquinariaequipo-table').DataTable({
    ...
    "columns": [ 
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='#' class='remove-maquinariaequipo'>" + 
            "<i class='fa fa-btn fa-thumbs-o-down' title='Desactivar maquinariaequipo'></i>" + 
            "</a>" + "</div>";
...
$('body').on('click', 'a.remove-maquinariaequipo', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    var url = "/maquinarias_equipo/remove/"+id;
