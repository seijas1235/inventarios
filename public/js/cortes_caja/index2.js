var cortes_caja_table = $('#cortes_caja-table').DataTable({
    "ajax": "/corte_caja_empleado/getJson",
    "responsive": true,
    "processing": true,
    "info": true,
    "showNEntries": true,
...
$('body').on('click', 'a.remove-corte_caja', function(e) {
...
$('body').on('click', 'button.confirm-delete', function( e ) {
    ...
    $.ajax({
        ...
        $(".user-created-message > p").text("Corte de Caja eliminado exitosamente!");
        cortes_caja_table.ajax.reload();
