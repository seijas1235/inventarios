var vehiculos_table = $('#vehiculos-table').DataTable({
    ...
    },
    {
        ...
        "render": function(data, type, full, meta) {
            ...
            "<a href='/vehiculos/edit/"+ full.id +"' class='edit-vehiculo'>" + 
            "<i class='fa fa-btn fa-edit' title='Editar Vehiculo'></i>" + 
            "</a>" + "</div>" + 
            "<div class='float-right col-lg-6'>" + 
            "<a href='#' class='remove-vehiculo'>" + 
            "<i class='fa fa-btn fa-thumbs-o-down' title='Desactivar Vehiculo'></i>" + 
            "</a>" + "</div>";
...
$('body').on('click', 'a.remove-vehiculo', function(e) {
