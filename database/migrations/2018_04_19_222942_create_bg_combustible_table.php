...
class CreateBgCombustibleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bg_combustible', function (Blueprint $tabla) {
